...
export default function AiSection() {
  return (
    <section
      id="ai"
      className="relative z-10 bg-[#000000] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] -mt-10 sm:-mt-12 md:-mt-14 px-5 sm:px-8 md:px-10 pt-14 sm:pt-16 md:pt-20 pb-10 sm:pb-12"
    >
      <FadeIn
        as="h2"
        delay={0}
